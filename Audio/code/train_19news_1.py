...
if not os.path.exists("../model/atcnet_pose0_con3/%s/atcnet_lstm_99.pth" % n):
    cmd = (
        "python atcnet.py --pose 1 --relativeframe 0 --dataset news --newsname 19_news/%s --start 0 --model_dir ../model/atcnet_pose0_con3/%s/ --continue_train 1 --lr 0.0001 --less_constrain 1 --smooth_loss 1 --smooth_loss2 1 --model_name ../model/atcnet_lstm_general.pth --sample_dir ../sample/atcnet_pose0_con3/%s --device_ids %d --max_epochs 100"
        % (n, n, n, gpu_id)
    )
    print(cmd)
    os.system(cmd)
