...
rasterize_triangles_module = tf.load_op_library(
    ...
    os.path.join(
        "/home4/yiran/TalkingFace/Pipeline/Deep3DFaceReconstruction",
...
def rasterize_clip_space(
    ...
    per_image_barycentric_coordinates = tf.TensorArray(
        dtype=tf.float32, size=batch_size
    )
    ...
    def batch_loop_iteration(
        ...
        per_image_barycentric_coordinates = per_image_barycentric_coordinates.write(
